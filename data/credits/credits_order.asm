...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_MODERATORS, CRED_AERO, CRED_ZACH, CRED_KARLOS, CRED_TEXT_FADE_MON
	db CRED_MODERATORS, CRED_ISONA, CRED_REGI, CRED_DAILY, CRED_TEXT_FADE_MON
	db CRED_MODERATORS, CRED_OBELISK, CRED_TEXT_FADE_MON

	db CRED_PLAYTESTERS, CRED_DISQ, CRED_BRICE, CRED_READERDRAGON, CRED_TEXT_FADE_MON
	db CRED_PLAYTESTERS, CRED_SABLE, CRED_SOUL, CRED_TALOS, CRED_TEXT_FADE_MON
	db CRED_PLAYTESTERS, CRED_ALAKADOOFF, CRED_RWNE, CRED_TEXT_FADE_MON

	db CRED_TUTORIALS, CRED_RANGI42, CRED_PLAGUEVONKARMA, CRED_JOJOBEAR13, CRED_TEXT_FADE_MON
	db CRED_TUTORIALS, CRED_YAKINEED, CRED_PGATTIC, CRED_XILLICIS, CRED_TEXT_FADE_MON
	db CRED_TUTORIALS, CRED_DANNYE, CRED_SOUPPOTATO, CRED_VOLOVED, CRED_TEXT_FADE_MON
	...
	db CRED_BACKSPRITE_ARTISTS, CRED_ZACH, CRED_ISONA, CRED_KARLOS, CRED_TEXT_FADE_MON
	db CRED_BACKSPRITE_ARTISTS, CRED_READERDRAGON, CRED_ALAKADOOFF, CRED_TEXT_FADE_MON
	db CRED_SPRITE_ARTISTS, CRED_LONGLOSTSOUL, CRED_GHOSTMISSINGNO, CRED_CHAMBER, CRED_TEXT_FADE_MON
	db CRED_SPRITE_ARTISTS, CRED_SOLOO993, CRED_BLUE_EMERALD, CRED_LAKE, CRED_TEXT_FADE_MON
	db CRED_SPRITE_ARTISTS, CRED_NESLUG, CRED_TOM_WANG, CRED_ZETANULL, CRED_TEXT_FADE_MON
	
	db CRED_PRET, CRED_TEXT_FADE_MON
