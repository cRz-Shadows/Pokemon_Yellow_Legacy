	...
	const_export SAFFRONPIDGEYHOUSE_GAMBLER
...
SaffronPidgeyHouse_Object:
	...
	object_event  0,  4, SPRITE_PIDGEY, WALK, UP_DOWN, TEXT_SAFFRONPIDGEYHOUSE_PIDGEY
	...
	object_event  7,  5, SPRITE_GAMBLER, STAY, LEFT, TEXT_SAFFRONPIDGEYHOUSE_GAMBLER
