...
CinnabarLabFossilRoom_Object:
	...
	object_event  0, 2, SPRITE_SCIENTIST, STAY, UP, TEXT_CINNABARLABFOSSILROOM_MOVE_DELETER
	object_event  3, 2, SPRITE_SCIENTIST, STAY, UP, TEXT_CINNABARLABFOSSILROOM_MOVE_RELEARNER
