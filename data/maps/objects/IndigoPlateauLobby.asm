...
IndigoPlateauLobby_Object:
	...
	object_event  4,  7, SPRITE_GYM_GUIDE, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_GYM_GUIDE
	...
	object_event  0,  7, SPRITE_CLERK, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_POST_GAME_CLERK
