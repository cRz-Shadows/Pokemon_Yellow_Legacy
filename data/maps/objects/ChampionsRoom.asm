...
ChampionsRoom_Object:
	...
	object_event  3,  2, SPRITE_JOLTEON, STAY, NONE, TEXT_CHAMPIONSROOM_JOLTEON
	object_event  3,  2, SPRITE_FLAREON, STAY, NONE, TEXT_CHAMPIONSROOM_FLAREON
	object_event  3,  2, SPRITE_VAPOREON, STAY, NONE, TEXT_CHAMPIONSROOM_VAPOREON
