...
; Characteristics of each move.
	...
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, TYPLESS,      100, 30
	...
	move WHIRLWIND,    SWITCH_AND_TELEPORT_EFFECT,   0, TYPLESS,       85, 20
	...
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, TYPLESS,      100, 15
	...
	move TAIL_WHIP,    DEFENSE_DOWN1_EFFECT,         0, TYPLESS,      100, 30
	...
	move LEER,         DEFENSE_DOWN1_EFFECT,         0, TYPLESS,      100, 30
	move BITE,         FLINCH_SIDE_EFFECT1,         60, DARK,         100, 25
	move GROWL,        ATTACK_DOWN1_EFFECT,          0, TYPLESS,      100, 40
	move ROAR,         SWITCH_AND_TELEPORT_EFFECT,   0, TYPLESS,      100, 20
	move SING,         SLEEP_EFFECT,                 0, TYPLESS,       55, 15
	move SUPERSONIC,   CONFUSION_EFFECT,             0, TYPLESS,       70, 20
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,        1, NORMAL,       100, 20
	move DISABLE,      DISABLE_EFFECT,               0, TYPLESS,       75, 20
	...
	move GROWTH,       SPECIAL_UP1_EFFECT,           0, TYPLESS,      100, 40
	...
	move MEDITATE,     ATTACK_UP1_EFFECT,            0, TYPLESS,   	  100, 40
	move AGILITY,      SPEED_UP2_EFFECT,             0, TYPLESS,      100, 30
	...
	move MIMIC,        MIMIC_EFFECT,                 0, TYPLESS,      100, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, TYPLESS,       85, 40
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, TYPLESS,      100, 15
	move RECOVER,      HEAL_EFFECT,                  0, TYPLESS,      100, 20
	move HARDEN,       DEFENSE_UP1_EFFECT,           0, TYPLESS,      100, 30
	move MINIMIZE,     EVASION_UP1_EFFECT,           0, TYPLESS,      100, 20
	move SMOKESCREEN,  ACCURACY_DOWN1_EFFECT,        0, TYPLESS,      100, 20
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, GHOST,        100, 10
	move WITHDRAW,     DEFENSE_UP1_EFFECT,           0, TYPLESS,      100, 40
	move DEFENSE_CURL, DEFENSE_UP1_EFFECT,           0, TYPLESS,      100, 40
	move BARRIER,      DEFENSE_UP2_EFFECT,           0, TYPLESS,	  100, 30
	move LIGHT_SCREEN, LIGHT_SCREEN_EFFECT,          0, TYPLESS,      100, 30
	move HAZE,         HAZE_EFFECT,                  0, TYPLESS,      100, 30
	move REFLECT,      REFLECT_EFFECT,               0, TYPLESS,      100, 20
	move FOCUS_ENERGY, FOCUS_ENERGY_EFFECT,          0, TYPLESS,      100, 30
	move BIDE,         BIDE_EFFECT,                  0, TYPLESS,      100, 10
	move METRONOME,    METRONOME_EFFECT,             0, TYPLESS,      100, 10
	...
	move AMNESIA,      SPECIAL_UP2_EFFECT,           0, TYPLESS,      100, 20
	move KINESIS,      ACCURACY_DOWN1_EFFECT,        0, TYPLESS,       80, 15
	move SOFTBOILED,   HEAL_EFFECT,                  0, TYPLESS,      100,  5
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           120, FIGHTING,      90, 20
	move GLARE,        PARALYZE_EFFECT,              0, TYPLESS,       90, 30
	...
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, TYPLESS,       75, 10
	move SKY_ATTACK,   NO_ADDITIONAL_EFFECT,        120, FLYING,       85, 10
	move TRANSFORM,    TRANSFORM_EFFECT,             0, TYPLESS,      100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      10, WATER,        100, 30
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       70, NORMAL,       100, 20
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,        100, 15
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, TYPLESS,       70, 20
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE,  95, 15
	move SPLASH,       SPLASH_EFFECT,                0, TYPLESS,      100, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, TYPLESS,      100, 40
	...
	move REST,         HEAL_EFFECT,                  0, TYPLESS,      100, 10
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,         75, ROCK,          95, 15
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,        90, 15
	move SHARPEN,      ATTACK_UP1_EFFECT,            0, TYPLESS,      100, 30
	move CONVERSION,   CONVERSION_EFFECT,            0, TYPLESS,      100, 30
	move TRI_ATTACK,   BURN_SIDE_EFFECT2,           85, NORMAL,       100, 15
	move SUPER_FANG,   SUPER_FANG_EFFECT,            1, NORMAL,        90, 10
	move SLASH,        NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 20
	move SUBSTITUTE,   SUBSTITUTE_EFFECT,            0, TYPLESS,      100, 10
	move STRUGGLE,     RECOIL_EFFECT,               50, TYPLESS,      100, 10
