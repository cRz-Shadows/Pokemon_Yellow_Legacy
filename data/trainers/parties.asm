...
Rival3Data:
; Champion's Room
	db $FF, 61, SANDSLASH,  61, DODRIO, 61, CLOYSTER, 63, ARCANINE, 64, ALAKAZAM, 65, JOLTEON, 0
	db $FF, 63, MAGNETON, 63, RHYDON, 64, CLOYSTER,  63, EXEGGUTOR,  64, ALAKAZAM, 65, FLAREON, 0
	db $FF, 61, VICTREEBEL, 61, PIDGEOT, 61, NINETALES, 63, MACHAMP, 64, ALAKAZAM, 65, VAPOREON, 0
