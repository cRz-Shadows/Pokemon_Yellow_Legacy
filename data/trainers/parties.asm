...
; Route 21
	db 35, SEAKING, GOLDEEN, SEAKING, SEAKING, 0
	db 37, SHELLDER, CLOYSTER, 0
	db $FF, 15, MAGIKARP, 30, GYARADOS, 32, GYARADOS, 34, GYARADOS, 36, GYARADOS, 38, GYARADOS,  0
	db 35, SEAKING, TENTACRUEL, 0
; Route 12
...
; Route 20
	...
	db 45, GYARADOS, 0
	db 42, DRAGONAIR, GYARADOS, SEADRA, 0
; Route 21
