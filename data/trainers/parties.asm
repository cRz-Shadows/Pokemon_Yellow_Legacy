...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 26, ONIX, 27, KANGASKHAN, 26, MAROWAK, 29, PERSIAN, 0
; Silph Co. 11F
	db $FF, 38, KINGLER,  37, MACHOKE , 39, GOLEM, 41, PERSIAN, 0
; Viridian Gym
	db $FF, 50, DUGTRIO, 53, NIDOQUEEN, 53, PERSIAN,  55, NIDOKING, 55, RHYDON, 0
...
KogaData:
	db $FF, 47, WEEZING, 46, GOLBAT, 47, MUK, 50, VENOMOTH, 0

BlaineData:
	db $FF, 53, RAPIDASH, 52, CHARIZARD, 53, NINETALES, 54, ARCANINE, 55, MAGMAR, 0

SabrinaData:
	db $FF, 50, ABRA,  45, HYPNO, 46, MR_MIME, 50, KADABRA,  50, ALAKAZAM, 0
