...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 26, ONIX, 27, KANGASKHAN 29, MAROWAK, 0
; Silph Co. 11F
...
SabrinaData:
	db $FF, 50, ABRA,  545, HYPNO, 50, KADABRA, 46, MRMIME, 50, ALAKAZAM, 0
	db $FF, 50, HYPNO,  50, SLOWBRO 50, KADABRA, 50, MRMIME,  50, ALAKAZAM, 0
	db $FF, 50, STARMIE,  50, SLOWBRO 50, JYNX, 50, EXEGGUTOR,  50, ALAKAZAM, 0
