...
; Route 11
	...
	db $FF, 17, RATTATA, RATTATA, 20, RATICATE, 0
...
; Silph Co. 7F
	db $FF, 43, GOLDUCK, 44, DODRIO, 43, PARASECT, 44, ALAKAZAM, 46, JOLTEON, 0
	db $FF, 43, ELECTABUZZ, 44, RHYDON, 43, PORYGON, 44, ALAKAZAM, 46, FLAREON, 0
	db $FF, 43, VICTREEBEL, 44, NINETALES, 43, PRIMEAPE, 44, ALAKAZAM, 46, VAPOREON, 0
; Route 22
	db $FF, 58, JOLTEON, 56, FEAROW, 55, MAROWAK, 57, ARCANINE, 55, CLOYSTER, 57, ALAKAZAM,  0
	db $FF, 57, GYARADOS, 55, MAGNETON, 56, EXEGGUTOR, 57, ALAKAZAM, 55, MAROWAK, 58, FLAREON, 0
	db $FF, 56, PIDGEOT, 57, MACHAMP, 57, ALAKAZAM, 55, NINETALES, 55, MAROWAK, 58, VAPOREON, 0
