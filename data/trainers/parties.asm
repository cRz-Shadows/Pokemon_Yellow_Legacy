...
; Victory Road 2F
	db 55, MACHOKE, MACHOP, MACHOKE, 0
...
; Silph Co. 2F
	...
	db 38, MAGNETON, ELECTRODEB, MAGNETON, 0
...
; Viridian Gym
	db $FF, 53, DUGTRIO, 54, NIDOQUEEN, 55, PERSIAN,  54, NIDOKING, 58, RHYDON, 0
...
BrunoData:
	db $FF, 55, HITMONCHAN, 56, POLIWRATH, 55, HITMONLEE, 56, ONIX, 58, MACHAMP, 0
...
; Pokémon Tower 2F
	db $FF, 25, FEAROW, 23, SHELLDER, 22, VULPIX, 20, KADABRA, 25, EEVEE, 0
	db $FF, 25, FEAROW, 23, MAGNEMITE, 22, KADABRA, 20, SCYTHER, 25, EEVEE, 0
	db $FF, 25, FEAROW, 23, VULPIX, 22, KADABRA, 20, SCYTHER, 25, EEVEE, 0
; Silph Co. 7F
...
; Route 22
	db $FF, 47, SCYTHER, 45, FEAROW, 45, ARCANINE, 47, CLOYSTER, 50, ALAKAZAM, 53, JOLTEON, 0
	db $FF, 47, SANDSLASH, 45, EXEGGUTOR, 45, GYARADOS, 47, MAGNETON, 50, ALAKAZAM, 53, FLAREON, 0
	db $FF, 47, VICTREEBEL, 45, PIDGEOT, 45, MACHAMP, 47, NINETALES, 50, ALAKAZAM, 53, VAPOREON, 0

Rival3Data:
; Champion's Room
	db $FF, 63, ARCANINE, 61, DODRIO, 64, ALAKAZAM, 61, SANDSLASH, 61, CLOYSTER,   65, JOLTEON, 0
	db $FF, 64, ALAKAZAM, 63, RHYDON, 64, GYARADOS, 63, MAGNETON, 63, EXEGGUTOR,  65, FLAREON, 0
	db $FF, 63, MACHAMP, 61, PIDGEOT, 61, NINETALES, 61, VICTREEBEL, 64, ALAKAZAM, 65, VAPOREON, 0
...
AgathaData:
	db $FF, 59, GENGAR, 58, GOLBAT, 57, MAROWAK, 58, ARBOK, 60, GENGAR, 0

LanceData:
	db $FF, 59, GYARADOS, 60, DRAGONITE, 59, CHARIZARD, 60, AERODACTYL, 62, DRAGONITE, 0
