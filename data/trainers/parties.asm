...
; Rematch
	db $FF, 60, PIKACHU, 60, PIKACHU, 60, PIKACHU, 60, PIKACHU, 60, PIKACHU, 60, PIKACHU, 0 ; Placeholder

BrockData:
	db $FF, 10, GEODUDE, 12, ONIX, 0
; Rematch
	db $FF, 60, OMASTAR, 60, ONIX, 60, KABUTOPS, 60, GOLEM, 60, NINETALES, 60, AERODACTYL, 0 ; Placeholder

MistyData:
	db $FF, 19, PSYDUCK, 18, GOLDEEN, 21, STARMIE, 0
; Rematch
	db $FF, 60, SEADRA, 60, GOLDUCK, 60, LAPRAS, 60, BLASTOISE, 60, VAPOREON, 60, STARMIE, 0 ; Placeholder

LtSurgeData:
	db $FF, 30, RAICHU, 0
; Rematch
	db $FF, 60, ELECTRODE, 60, MAGNETON, 60, JOLTEON, 60, PORYGON, 60, ELECTABUZZ, 60, RAICHU, 0 ; Placeholder
...
; Rematch
	db $FF, 60, TANGELA, 60, VENUSAUR, 60, PARASECT, 60, EXEGGUTOR, 60, VICTREEBEL, 60, VILEPLUME, 0 ; Placeholder

KogaData:
	db $FF, 44, GOLBAT, 43, MUK, 44, TENTACRUEL, 45, VENOMOTH, 0
	db $FF, 49, GOLBAT, 48, MUK, 49, TENTACRUEL, 48, WEEZING, 50, VENOMOTH, 0
; Rematch
	db $FF, 60, GOLBAT, 60, MUK, 60, TENTACRUEL, 60, WEEZING, 60, ARBOK, 60, VENOMOTH, 0 ; Placeholder

BlaineData:
	db $FF, 53, RAPIDASH, 52, CHARIZARD, 53, NINETALES, 54, ARCANINE, 55, MAGMAR, 0
; Rematch
	db $FF, 60, RAPIDASH, 60, FLAREON, 60, CHARIZARD, 60, NINETALES, 60, ARCANINE, 60, MAGMAR, 0 ; Placeholder

SabrinaData:
	db $FF, 50, ABRA,  48, HYPNO, 49, MR_MIME, 50, KADABRA,  50, ALAKAZAM, 0
	db $FF, 45, ABRA,  44, MR_MIME, 45, KADABRA,  45, ALAKAZAM, 0
; Rematch
	db $FF, 60, MR_MIME, 60, HYPNO, 60, SLOWBRO, 60, JYNX, 60, GENGAR, 60, ALAKAZAM, 0 ; Placeholder
...
; Route 22
	db $FF, 58, JOLTEON, 56, PIDGEOT, 55, EXEGGUTOR , 55, MAROWAK,  57, ALAKAZAM, 57, ARCANINE, 0
	db $FF, 57, FEAROW, 55, MAGNETON, 56, GOLDUCK, 57, ALAKAZAM, 55, MAROWAK, 58, FLAREON, 0
	db $FF, 56, PIDGEOT, 57, MACHAMP, 57, ALAKAZAM, 55, NINETALES, 55, SCYTHER, 58, VAPOREON, 0
	
Rival3Data: 
; Champion's Room
	db $FF, 64, ALAKAZAM, 63, RHYDON, 64, GYARADOS, 64, ARCANINE, 64, EXEGGUTOR, 65, JOLTEON, 0
	db $FF, 63, MAGNETON, 64, DODRIO, 64, ALAKAZAM, 63, SANDSLASH, 63, CLOYSTER,  65, FLAREON, 0
