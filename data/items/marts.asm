...
IndigoPlateauLobbyClerkText::
	script_mart FULTRA_BALL, HYPER_ POTION, FULL_RESTORE, REVIVE, FULL_HEAL, MAX_REPEL, TM_ICE_BEAM, TM_THUNDERBOLT, TM_FLAMETHROWER, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_SUBMISSION, TM_ROCK_SLIDE, TM_DREAM_EATER
