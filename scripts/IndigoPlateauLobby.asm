...
IndigoPlateauLobbyPostGameClerkText::
	script_mart TM_SWORDS_DANCE, TM_TOXIC, TM_HORN_DRILL, TM_BODY_SLAM, TM_DOUBLE_EDGE, TM_BLIZZARD, TM_THUNDER, TM_EARTHQUAKE, TM_FISSURE, TM_PSYCHIC_M, TM_FIRE_BLAST, TM_SKY_ATTACK, TM_EXPLOSION
