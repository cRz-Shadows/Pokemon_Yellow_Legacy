...
IndigoPlateauLobbyClerkText::
	script_mart  ULTRA_BALL, HYPER_POTION, FULL_RESTORE, REVIVE, FULL_HEAL, MAX_REPEL, TM_ICE_BEAM, TM_THUNDERBOLT, TM_FLAMETHROWER, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_SUBMISSION, TM_ROCK_SLIDE, TM_DREAM_EATER

IndigoPlateauLobbyPostGameClerkText::
	script_mart  TM_BODY_SLAM, TM_HORN_DRILL, TM_DOUBLE_EDGE, TM_PSYCHIC_M, TM_TOXIC, TM_THUNDER, TM_SWORDS_DANCE, TM_EARTHQUAKE, TM_BLIZZARD, TM_FIRE_BLAST, TM_FISSURE, TM_EXPLOSION, TM_SKY_ATTACK
