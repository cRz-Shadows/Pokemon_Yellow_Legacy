...
ViridianMartClerkText::
	script_mart POKE_BALL, POTION, ANTIDOTE, PARLYZ_HEAL, AWAKENING, POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, SUPER_REPEL, TM_SWIFT, TM_BIDE, TM_DREAM_EATER, TM_BUBBLEBEAM