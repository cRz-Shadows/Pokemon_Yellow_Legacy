...
ViridianMartClerkText::
	script_mart POKE_BALL, POTION, ANTIDOTE, PARLYZ_HEAL, AWAKENING, POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, FULL_RESTORE, FULL_HEAL, SUPER_POTION, SUPER_REPEL